...
public class OwnerResource {
	...
	@PostMapping
	public ResponseEntity<Owner> create(@Valid @RequestBody Owner obj) {
		obj.setId(null);
	...
	@PutMapping (value = "/{id}")
	public ResponseEntity<OwnerDTO> update(@PathVariable Integer id, @Valid @RequestBody OwnerDTO ownerDTO) {
